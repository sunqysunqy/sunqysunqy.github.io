...
- `ICLR 2025` [ST-GCond: Self-supervised and Transferable Graph Dataset Condensation](https://openreview.net/pdf?id=wYWJFLQov9), Jiayi Luo, **Qingyun Sun#**, Haonan Yuan, Xingcheng Fu, Jianxin Li 
- `WWW 2025` [Robust Graph Learning Against Adversarial Evasion Attacks via Prior-Free Diffusion-Based Structure Purification](https://openreview.net/pdf?id=pwdRhjHrEx), Beining Yang, **Qingyun Sun#**, Cheng Ji, Xingcheng Fu, Jianxin Li
